...
SECRET_KEY = env("SECRET_KEY", "django-insecure-ucso*_rkvp%t@up&w9p$2&y6j%czdjh#hkx9w$o$e*$=$#(nsm")
...
if USE_AWS:
    ...
    DEFAULT_FILE_STORAGE = 'mecania.storages.CustomS3Boto3Storage'
    STATICFILES_STORAGE = 'mecania.storages.CustomS3Boto3Storage'
else:

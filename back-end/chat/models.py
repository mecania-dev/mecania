...
class ChatGroup(models.Model):
    ...
    # Think about adding a vehicle field to the ChatGroup model
    # vehicle = models.ForeignKey(Vehicle, on_delete=models.SET_NULL, related_name="chat_groups", blank=True)
